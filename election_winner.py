...
def send_uin_email(email, uin):
    try:
        ...
        Thank you for registering in our Voting System!
        
        Your Unique Identification Number (UIN) is: {uin}
        
        Please keep this number safe and confidential as you will need it to cast your vote.
        Do not share this UIN with anyone.
        
        Best regards,
        Election Team
        """]

        yag.send(email, 'Your Voting UIN', contents)
        print(f"Email sent successfully to {email}")
        return True
    except Exception as e:
        print(f"Error sending email: {str(e)}")  # More detailed error logging
        return False
